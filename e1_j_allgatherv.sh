...
srun -n 128 --exclusive julia --project e1_j_allgatherv.jl
srun -n 126 --exclusive /scratch/hpc-prf-mpibj/com/osu-micro-benchmarks-7.0.1/c/mpi/collective/osu_allgatherv -m 183500 -i  -f
