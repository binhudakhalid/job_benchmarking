...
srun -n 256 --exclusive julia --project e1_j_gatherv.jl
srun -n 256 --exclusive /scratch/hpc-prf-mpibj/com/osu-micro-benchmarks-7.0.1/c/mpi/collective/osu_gatherv -m 2097152 -i 262144 -f
