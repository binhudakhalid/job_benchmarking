...
srun -n 128 --exclusive julia --project e1_j_gather.jl
srun -n 128 --exclusive /scratch/hpc-prf-mpibj/com/osu-micro-benchmarks-7.0.1/c/mpi/collective/osu_gather -m 2097152 -i 262144 -f
