...
srun -n 2 --exclusive julia --project e1_j_accumulate_latency_fence.jl
srun -n 2 --exclusive /scratch/hpc-prf-mpibj/com/osu-micro-benchmarks-7.0.1/c/mpi/one-sided/osu_acc_latency -s fence -w create -m 2097152 -i 262144
